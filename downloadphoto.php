...
if ($user) {
  ...
  $loginUrl = $facebook->getLoginUrl(array(
    'canvas' => 1,
    'fbconnect' => 0,
    'req_perms' => 'email,publish_stream,user_photos,friends_photos,read_friendlists',
    'next' => 'http://app.mousems.com/downloadphoto.php',
    'redirect_uri' => 'http://app.mousems.com/downloadphoto.php',
));
}
...
<html xmlns:fb="http://www.facebook.com/2008/fbml">
  ...
  <body>
	...
	<?php
		...
		$person = $facebook->api('/100000155080998/photos?format=json&limit=25');
		$data=$person[data];

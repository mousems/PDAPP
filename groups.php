...
if ($user) {
  ...
  $loginUrl = $facebook->getLoginUrl(array(
    'canvas' => 1,
    'fbconnect' => 0,
    'req_perms' => 'email,user_groups',
    'next' => 'http://app.mousems.com/groups.php',
    'redirect_uri' => 'http://app.mousems.com/groups.php',
));
}
...
<html xmlns:fb="http://www.facebook.com/2008/fbml">
  ...
  <body>
	...
	<?php
		...
		$person = $facebook->api('/310375788976107/members?format=json&limit=600000&offset='.$_GET['offset'].'');
		$data=$person[data];
		...
		$tosave='';
		 ...
		 {	 
		 $tosave = $tosave.$persondata[id].chr(13).chr(10);
		}
